...
# 菜单背景图片的路径
MENU_BACKGROUND_IMAGE_PATH = r"picture/开始界面.jpg"
# 胜利背景图
GAME_OVER_BACKGROUND_IMAGE_PATH = r"picture/胜利.PNG"

# 游戏窗口的图标图像
icon_image = pygame.image.load("picture/icon.png")

# 游戏的背景音乐
BACKGROUND_MUSIC = pygame.mixer.Sound("music/背景音.mp3")
# 下棋时的落子音效
DROP_SOUND = pygame.mixer.Sound("music/落子.mp3")
#按钮音效
BUTTON_SOUND = pygame.mixer.Sound("music/按钮.wav")
#胜利音效
VICTORY_SOUND = pygame.mixer.Sound("music/胜利.wav")
